...
public class SignController {
    ...
    public SignInResultDto signIn(
        @ApiParam(value = "ID", readOnly = true) @RequestParam String id,
        @ApiParam(value = "Password", readOnly = true) @RequestParam String password
    ...
    public SignUpResultDto signUp(
        @ApiParam(value = "ID", readOnly = true) @RequestParam String id,
        @ApiParam(value = "비밀번호", readOnly = true) @RequestParam String password,
        @ApiParam(value = "이름", readOnly = true) @RequestParam String name,
        @ApiParam(value = "권한", readOnly = true) @RequestParam String role
    ) {
